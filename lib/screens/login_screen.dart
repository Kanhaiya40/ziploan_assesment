              ...
              Expanded(
                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child:
                        Image.asset(defaultImagePath + 'login_welcome_content.png'),
                  ),
                ),
              )),
              Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TextFormField(
                          ...
                          validator: (value)=>MobileNumberValidator.validate(value!),
                        ),
                        SizedBox(
                          height: 10,
                        ),
                        ...
                        Text(isChecked?'':checkboxError,style: checkBoxErrorStyle,),
                        SizedBox(
                          height: 10,
                        ),
                        buildContinueButton(
                            func: validateFormAndNavigateToOtpScreen,
                            context: context,isChecked: isChecked),
